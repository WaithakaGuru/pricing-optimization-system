      ...
      <div className="bg-[--color-surface] border border-[--color-border] rounded-2xl shadow-2xl max-w-sm w-full animate-scale-up">
        ...
        <div className="flex items-start justify-between px-6 py-5 border-b border-[--color-border]">
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-[--color-text-primary]">{product.name}</h2>
            <p className="text-sm text-[--color-text-tertiary] mt-1">Product Details</p>
          </div>
        ...
        <div className="px-6 py-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex justify-between items-center p-3 bg-[--color-surface-2] rounded-lg">
              <span className="text-sm text-[--color-text-secondary]">Current Price</span>
            ...
            <div className="flex justify-between items-center p-3 bg-[--color-surface-2] rounded-lg">
              <span className="text-sm text-[--color-text-secondary]">Cost Price</span>
            ...
            <div className="flex justify-between items-center p-3 bg-[--color-surface-2] rounded-lg">
              <span className="text-sm text-[--color-text-secondary]">Margin</span>
              <span className="text-lg font-semibold text-green-600 font-mono">
                {((((product.current_price - product.cost_price) / product.cost_price) * 100)).toFixed(1)}%
              </span>
            </div>
          </div>
          ...
          <div className="mb-6 p-3 bg-[--color-accent-light] border border-[--color-accent]/20 rounded-lg">
            <p className="text-xs text-[--color-text-tertiary] mb-1">Total for this order</p>
