...
export default function CartPanel({
  ...
  return (
    <div className="bg-[--color-surface] border border-[--color-border] rounded-2xl flex flex-col h-full shadow-sm overflow-hidden">
          ...
          items.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-[--color-text-primary] font-mono w-4 text-center">
                  {item.quantity}
                </span>
                <button
                  onClick={() =>
      ...
      {/* Footer */}
      <div className="shrink-0 border-t border-[--color-border] bg-[--color-surface-2] px-5 py-4 flex flex-col gap-2">
